    ...
    <main className="min-h-screen bg-black dark:bg-black">
      ...
      <section className="flex flex-col items-center justify-center min-h-screen py-8 sm:py-12 md:py-20 px-4 relative overflow-hidden">
        ...
        <div className="w-full relative z-10">
          <ContainerScroll
            titleComponent={
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-6xl font-bold mb-4 sm:mb-6 text-transparent bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text dark:from-white dark:via-primary dark:to-white px-4">
      ...
      <section className="py-8 sm:py-12 md:py-20 px-4 bg-white dark:bg-black relative overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center space-y-6 sm:space-y-8 md:space-y-12 relative z-10">
          <div className="text-center max-w-4xl px-4">
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 md:mb-6 text-transparent dark:text-white bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent dark:from-white dark:via-primary dark:to-white">
              About Keradon
            </h3>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground dark:text-gray-300 leading-relaxed px-2">
          ...
          <div className="transform hover:scale-105 transition-all duration-500">
            <EvervaultCard text="Data Scraping" className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80" />
          </div>
        </div>
      </section>
      ...
      <section className="py-8 sm:py-12 md:py-20 px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20 px-4">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-6xl font-bold mb-3 sm:mb-4 md:mb-6 text-foreground dark:text-white bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent dark:from-white dark:via-primary dark:to-white">
              Why Choose Keradon?
            </h2>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed dark:text-white/70 px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12">
            ...
            <div className="group relative transition-transform duration-300 hover:-translate-y-2 hover:scale-105">
              ...
              <div className="relative bg-white/90 dark:bg-black/90 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-2xl hover:shadow-3xl transition-all duration-500 ease-in-out group-hover:ring-2 group-hover:ring-blue-400/40">
                <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 md:mb-8 group-hover:scale-110 transition-all duration-300 shadow-lg">
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 text-foreground dark:text-white group-hover:text-blue-500 transition-colors duration-300">
                  Lightning Fast
                </h3>
            ...
            <div className="group relative transition-transform duration-300 hover:-translate-y-2 hover:scale-105">
              ...
              <div className="relative bg-white/90 dark:bg-black/90 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-2xl hover:shadow-3xl transition-all duration-500 ease-in-out group-hover:ring-2 group-hover:ring-green-400/40">
                <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-gradient-to-br from-green-500 to-teal-600 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 md:mb-8 group-hover:scale-110 transition-all duration-300 shadow-lg">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 text-foreground dark:text-white group-hover:text-green-500 transition-colors duration-300">
                  No Code Required
                </h3>
                <p className="text-xs sm:text-sm md:text-base text-muted-foreground dark:text-gray-300 leading-relaxed">
            ...
            <div className="group relative transition-transform duration-300 hover:-translate-y-2 hover:scale-105">
              ...
              <div className="relative bg-white/90 dark:bg-black/90 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-2xl hover:shadow-3xl transition-all duration-500 ease-in-out group-hover:ring-2 group-hover:ring-orange-400/40">
                <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 md:mb-8 group-hover:scale-110 transition-all duration-300 shadow-lg">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 text-foreground dark:text-white group-hover:text-orange-500 transition-colors duration-300">
                  LLM Integration
                </h3>
                <p className="text-xs sm:text-sm md:text-base text-muted-foreground dark:text-gray-300 leading-relaxed">
        ...
        <div className="w-full max-w-6xl relative z-10 animate-fade-in animation-delay-300 px-4">
          <div className="flex justify-center">
            ...
            <Card className="bg-background/90 backdrop-blur-xl border-border hover:border-border/50 transition-all duration-300 dark:bg-black/90 dark:border-gray-800/30 dark:hover:border-gray-700/50 shadow-xl hover:shadow-2xl w-full max-w-xl">
              <CardHeader className="px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
                <CardTitle className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold mb-3 sm:mb-4 md:mb-6 animate-slide-up text-foreground dark:text-white leading-tight bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent dark:from-white dark:via-primary dark:to-white">
      ...
      {/* Final Section */}
      <section id="final-section" className="w-full min-h-screen flex flex-col items-center justify-center relative overflow-hidden py-4 sm:py-8 md:py-12 lg:py-20 px-4">
        <div className="absolute inset-0 bg-gradient-to-br from-background via-gray-100 to-background opacity-95 animate-gradient-x dark:from-black dark:via-gray-900 dark:to-black"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-transparent via-background/50 to-background animate-pulse dark:from-transparent dark:via-black/50 dark:to-black"></div>
        ...
        <Card className="relative z-10 max-w-4xl w-full mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16 bg-background/70 backdrop-blur-xl border-border dark:bg-black/70 dark:border-gray-800/30 shadow-2xl">
          <CardHeader className="px-2 sm:px-4">
            <CardTitle className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl 3xl:text-7xl font-extrabold text-center mb-3 sm:mb-4 md:mb-6 animate-slide-up text-foreground drop-shadow-lg dark:text-white leading-tight bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent dark:from-white dark:via-primary dark:to-white">
              No Code.No Noise.Just Smart Web Scraping
            </CardTitle>
            <CardDescription className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-muted-foreground text-center mb-4 sm:mb-6 md:mb-8 lg:mb-10 animate-fade-in animation-delay-200 font-medium dark:text-gray-200 leading-relaxed">
              Try Keradon for free.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col items-center gap-4 px-2 sm:px-4">
            <a href="/oss_program" className="text-muted-foreground hover:text-foreground transition animate-fade-in block text-xs sm:text-sm md:text-base lg:text-lg underline dark:text-gray-300 dark:hover:text-white text-center hover:scale-105 transform transition-all duration-300">
